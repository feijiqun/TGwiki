...
5. 当页面出现`选择登录邮箱`（`Choose a login email`），根据提示输入完成邮箱验证码后会向你的账号绑定手机号码发送短信验证码，输入完即可开启邮箱登录。
   ...
   ![tfa-emaillogin1.jpg](https://cdn.jsdelivr.net/gh/feijiqun/images/tfa/emaillogin1.jpg)

   ![tfa-emaillogin2.jpg](https://cdn.jsdelivr.net/gh/feijiqun/images/tfa/emaillogin2.jpg)
...
6. 开启邮箱登录后，在`隐私设置`中会新增一个`登录邮箱`字段。
   ...
   ![privacy1.jpg](https://cdn.jsdelivr.net/gh/feijiqun/images/tfa/privacy1.jpg)
