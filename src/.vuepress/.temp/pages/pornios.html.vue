<template><div><p>Telegram如果你进入某个群或频道遇到如下提示：
<code v-pre>This channel can't be displayed because it was used to spread pornographic content.</code></p>
<h2 id="具体原因" tabindex="-1"><a class="header-anchor" href="#具体原因"><span>具体原因</span></a></h2>
<ul>
<li>有人在群里发了色情内容，被人举报后，被Telegram官方限制了；</li>
<li>Telegram官方只会处理举报的，不会主动审查，如果没人举报就不会被限制；</li>
<li>只有iOS&amp;Mac上App Store里下载的客户端会有此限制，这是因为Apple的限制，上架App Store的内容限制，其他客户端无此限制，可以正常进入群。</li>
</ul>
<div class="hint-container important">
<p class="hint-container-title">重要</p>
<p>巴基斯坦、哈萨克斯坦、伊朗、印度、印度尼西亚、马来西亚等地区的号码没有此选项，无法解除敏感内容限制。</p>
</div>
...
<ul>
<li>手机或电脑浏览器访问 <a href="https://web.telegram.org/" target="_blank" rel="noopener noreferrer">官方网页版（A版）</a> ；</li>
<li>扫描二维码或输入手机号码登录；</li>
<li>主界面-&gt;左上角三短线-&gt;<code v-pre>Settings</code>-&gt;点击<code v-pre>Privacy and Security</code>-&gt;滑动到底部，打开<code v-pre>Show 18+ content</code>。</li>
</ul>
<div class="hint-container warning">
<p class="hint-container-title">注意</p>
<p>必须用浏览器打开，验证码是优先发送到之前已登录的Telegram设备/客户端/App上。</p>
...
<ul>
<li>手机或电脑浏览器访问 <a href="https://web.telegram.org/k/" target="_blank" rel="noopener noreferrer">官方网页版（K版）</a> ；</li>
<li>扫描二维码或输入手机号码登录；</li>
<li>主界面-&gt;左上角三短线-&gt;<code v-pre>Settings</code>-&gt;<code v-pre>Privacy and Security</code>-&gt;打开<code v-pre>Disable filtering</code>。</li>
</ul>
<div class="hint-container warning">
<p class="hint-container-title">注意</p>
<p>必须用浏览器打开，验证码是优先发送到之前已登录的Telegram设备/客户端/App上。</p>
