<template><div><h2 id="功能说明" tabindex="-1"><a class="header-anchor" href="#功能说明"><span>功能说明</span></a></h2>
<p>Telegram客户端官方已添加&quot;投票&quot;功能，可以实时显示投票人数和比例。</p>
...
<p>创建者可以：</p>
<ol>
<li>创建投票（支持匿名投票、小测验模式）；</li>
<li>长按/右键可以停止投票；</li>
<li>长按/右键可以撤回投票，重新投票。</li>
</ol>
<p>使用者可以：</p>
<ol>
<li>点击选项即可投票；</li>
...
<h2 id="创建投票" tabindex="-1"><a class="header-anchor" href="#创建投票"><span>创建投票</span></a></h2>
<ul>
<li>
<p>Telegram iOS：<code v-pre>点击左下角别针按钮</code>-&gt;<code v-pre>投票(Poll)</code></p>
</li>
<li>
...
<li>
<p>Telegram macOS：鼠标停留在左下角别针按钮上-&gt;<code v-pre>投票</code>(``Poll`)</p>
</li>
<li>
