<template><div><h2 id="说明" tabindex="-1"><a class="header-anchor" href="#说明"><span>说明</span></a></h2>
<ul>
<li>
<p>群组人数最高20万。</p>
</li>
<li>
<p>超过<code v-pre>199000</code>人可以转换为广播群组（Broadcast Group）。转换后，人数将不受限制，但只有管理员可以说话，但是成员仍然可以加入语音聊天。<a href="https://telegram.org/blog/autodelete-inv2#groups-with-unlimited-members" target="_blank" rel="noopener noreferrer">点击查看官方说明</a>。</p>
<div class="hint-container warning">
<p class="hint-container-title">注意</p>
<p>请注意，切换为广播群组之后，将不能回退到普通群组。</p>
</div>
</li>
<li>
<p>静音群组只有在提到你（@）、回复你（Reply）和管理员置顶消息（Pin）时才会收到通知。</p>
</li>
<li>
<p>加入群组之前，可看到（单向）好友是否在列。如果不想让好友知道你加入了某个群组，注册一个小号吧。</p>
</li>
<li>
<p>支持在任何设备上发起语音聊天。</p>
</li>
...
<p>仅群组创建者可以修改<code v-pre>群组类型</code>。</p>
</div>
<p>可以设置为<code v-pre>公开</code>或<code v-pre>私有</code>，公开群组将允许用户通过搜索用户名加入，私有群组只能通过邀请链接入群。公开群组的聊天记录将对所有用户可见，私有群组只有加入后才能看的聊天记录。特别的，私有群组可以对新加入的用户隐藏历史聊天记录。</p>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>你可以在此项设置底部开启<code v-pre>禁止成员复制、保存和转发群组内容</code>。</p>
</div>
<h2 id="话题" tabindex="-1"><a class="header-anchor" href="#话题"><span>话题</span></a></h2>
<p>群组创建者可以开启/关闭话题（Topics）功能。开启后，群组将分为多个对话，群成员可以讨论不同内容，类似Discord。</p>
<ul>
<li>
<p>群成员（若权限允许）可以创建不同的话题并对每个话题设置一个图标。同时，每个话题会自动生成一个内部链接。</p>
</li>
<li>
...
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>有关联频道（作为评论）的群组无法开启“话题”功能。</p>
</div>
<h2 id="成员权限" tabindex="-1"><a class="header-anchor" href="#成员权限"><span>成员权限</span></a></h2>
<p>管理员可以限制所有成员或单个成员只能发送特定类型的内容。</p>
<p>如此一来，你便可建立一个没有表情贴纸或者GIF的高质量交流社区。或者甚至完全限制成员发送信息，让管理员彼此交谈，而群成员则默默地旁观。</p>
<ul>
<li><code v-pre>置顶消息</code>和<code v-pre>修改群组信息</code>权限在公开群组对普通成员不开放。</li>
...
<div class="hint-container tip">
<p class="hint-container-title">提示</p>
<p>公开群组的此项设置在<code v-pre>群组类型</code>-&gt;<code v-pre>管理邀请链接</code>中。</p>
</div>
<p>除公开链接外，群管理员可以设置多个邀请链接（格式：<code v-pre>https://t.me/+xxx</code>）。对于每个邀请链接，可以设置有效时间、次数限制。邀请链接可以随时撤销、关闭。</p>
<p><strong>入群审核</strong>：</p>
<ul>
<li><code v-pre>私有群组</code>可以为每个邀请链接单独设置是否需要开启<code v-pre>入群审核</code>。</li>
...
<h2 id="成员" tabindex="-1"><a class="header-anchor" href="#成员"><span>成员</span></a></h2>
<h3 id="强力反垃圾" tabindex="-1"><a class="header-anchor" href="#强力反垃圾"><span>强力反垃圾</span></a></h3>
<p>这是Telegram官方提供的一个反垃圾服务。</p>
<div class="hint-container caution">
<p class="hint-container-title">警告</p>
<p>该功能尚不完善，误杀概率很大，且被限制的用户将无法在公开群组中发送消息。不建议开启此功能！</p>
</div>
<h3 id="隐藏成员列表" tabindex="-1"><a class="header-anchor" href="#隐藏成员列表"><span>隐藏成员列表</span></a></h3>
<p>开启后，非群组管理员将无法查看完整的成员列表，仅能看到管理员列表。</p>
<h2 id="其他" tabindex="-1"><a class="header-anchor" href="#其他"><span>其他</span></a></h2>
<ul>
<li>管理员可删除成员的单条消息或全部消息。</li>
<li>可对群主（creator）及管理员（administrators）设置自定义头衔。</li>
<li>管理员可以匿名发布消息（在管理员权限处设置）。</li>
<li>成员超过500人后，自动开通群组分析（<code v-pre>统计数据</code>）功能。</li>
<li>群组获得助推后将开启高级功能（修改主页外观、发布动态、自定义emoji包等），具体请参阅 <RouteLink to="/boost.html">此处</RouteLink> 。</li>
</ul>
</div></template>
