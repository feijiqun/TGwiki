...
export default defineUserConfig({
  ...
  description: 'TGwiki (Telegram Wiki) - Telegram知识库，由✈️飞机群打造的高质量Telegram知识库，汇集了Telegram常用功能介绍和使用说明，帮助用户更全面地了解Telegram的各种功能。',
  head: [
    ...
    ['script', {async: true, src: 'https://static.getclicky.com/101488423.js'}],
    ['noscript', {}, `<p><img alt="Clicky" width="1" height="1" src="//in.getclicky.com/101488423ns.gif" /></p>`],
